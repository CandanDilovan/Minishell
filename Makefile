...
#    Updated: 2023/08/01 16:55:26 by dilovancand      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = Minishell
SOURCES = src/minishell.c src/signal_handler.c src/ft_path_finder.c src/ft_path_finder_utils.c src/ft_parsing_utils.c
OBJECTS = $(SOURCES:.c=.o)
